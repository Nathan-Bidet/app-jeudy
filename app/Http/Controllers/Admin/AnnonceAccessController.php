...
class AnnonceAccessController extends Controller
{
    /**
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        DB::transaction(function () use ($validated, $request): void {
            foreach ($validated['roles'] ?? [] as $row) {
                ...
                $withoutAnnonces = array_values(array_diff($current, self::ABILITIES));
        ...
        $this->auditLogService->log([
            ...
            'module' => 'annonces',
            'description' => 'Mise à jour des droits du module Annonces',
            'payload' => [
                'before' => $before,
                'after' => $this->snapshot(),
            ],
        ...
        return back()->with('status', 'Annonces permissions updated.');
    }
